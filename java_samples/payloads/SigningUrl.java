...
public class SigningUrl {
	...
	public CloseableHttpResponse fetch_embedded_signing_url(String base_url, String api_token) throws Exception 
	{
		String string = String.format("v1/files/pending/%d/signing/url/", this.id);
